...
// posts below are for pagination purposes only 
const post10 = await posts.create(user4._id, "Bald Eagle", ["https://guides.nynhp.org/media/i5339.jpg"], "Hello people of the internet. What is this thing?", "14140 Forsythe Road, Sykesville, Howard County, MD 21784, United States of America", [39.343449, -77.005591]);
const post11 = await posts.create(user4._id, "Blue Jay", ["https://cdn.download.ams.birds.cornell.edu/api/v1/asset/311635911/1800"], "Hello people of the internet. What is this thing?", "14140 Forsythe Road, Sykesville, Howard County, MD 21784, United States of America", [39.343449, -77.005591]);
const post12 = await posts.create(user4._id, "Scarlet Macaw", ["https://cdn.download.ams.birds.cornell.edu/api/v1/asset/320977231/900"], "Hello people of the internet. What is this thing?", "14140 Forsythe Road, Sykesville, Howard County, MD 21784, United States of America", [39.343449, -77.005591]);
const post13 = await posts.create(user4._id, "Great Horned Owl", ["https://www.allaboutbirds.org/guide/assets/photo/297363481-480px.jpg"], "Hello people of the internet. What is this thing?", "14140 Forsythe Road, Sykesville, Howard County, MD 21784, United States of America", [39.343449, -77.005591]);
const post14 = await posts.create(user4._id, "Peregrine Falcon", ["https://www.allaboutbirds.org/guide/assets/photo/303618951-480px.jpg"], "Hello people of the internet. What is this thing?", "14140 Forsythe Road, Sykesville, Howard County, MD 21784, United States of America", [39.343449, -77.005591]);
const post15 = await posts.create(user4._id, "European Robin", ["https://www.birdguides-cdn.com/cdn/gallery/birdguides/8b12224d-0a6e-4752-9e32-901401e64538.jpg"], "Hello people of the internet. What is this thing?", "14140 Forsythe Road, Sykesville, Howard County, MD 21784, United States of America", [39.343449, -77.005591]);
const post16 = await posts.create(user4._id, "American Goldfinch", ["https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvGgNJtYcP6C4nTmyBlIGktrP4jxVyw7C0IVZVZvvN35uqHQY0"], "Hello people of the internet. What is this thing?", "14140 Forsythe Road, Sykesville, Howard County, MD 21784, United States of America", [39.343449, -77.005591]);
const post17 = await posts.create(user4._id, "African Grey Parrot", ["https://www.marylandzoo.org/wp-content/uploads/2017/10/african_grey_web-1024x683.jpg"], "Hello people of the internet. What is this thing?", "14140 Forsythe Road, Sykesville, Howard County, MD 21784, United States of America", [39.343449, -77.005591]);
const post18 = await posts.create(user4._id, "Snowy Owl", ["https://i.natgeofe.com/k/90bac473-ad17-4d15-a2c5-450dad846d4f/snowy-owl-yawn_square.jpg"], "Hello people of the internet. What is this thing?", "14140 Forsythe Road, Sykesville, Howard County, MD 21784, United States of America", [39.343449, -77.005591]);
const post19 = await posts.create(user4._id, "Mandarin Duck", ["https://upload.wikimedia.org/wikipedia/commons/4/43/Pair_of_mandarin_ducks.jpg"], "Hello people of the internet. What is this thing?", "14140 Forsythe Road, Sykesville, Howard County, MD 21784, United States of America", [39.343449, -77.005591]);
const post20 = await posts.create(user4._id, "Black-bellied Plover", ["https://www.allaboutbirds.org/guide/assets/photo/297925101-480px.jpg"], "Hello people of the internet. What is this thing?", "14140 Forsythe Road, Sykesville, Howard County, MD 21784, United States of America", [39.343449, -77.005591]);
const post22 = await posts.create(user4._id, "American Golden-Plover", ["https://cdn.download.ams.birds.cornell.edu/api/v1/asset/297937901/1800"], "Hello people of the internet. What is this thing?", "14140 Forsythe Road, Sykesville, Howard County, MD 21784, United States of America", [39.343449, -77.005591]);
const post21 = await posts.create(user4._id, "Snowy Plover", ["https://www.allaboutbirds.org/guide/assets/photo/297949771-480px.jpg"], "Hello people of the internet. What is this thing?", "14140 Forsythe Road, Sykesville, Howard County, MD 21784, United States of America", [39.343449, -77.005591]);
