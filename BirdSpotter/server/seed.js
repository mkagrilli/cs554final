...
const post1 = await posts.create(user1._id, "Raven I think?", "https://cdn.download.ams.birds.cornell.edu/api/v1/asset/85864161/1800", "I think its a raven, but might also be a crow. I also don't know specific breeds as well.", "Brooklyn, NY", "placeholder");
